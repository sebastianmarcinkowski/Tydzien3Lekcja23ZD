	...
	internal class Program
	{
		static void Main(string[] args)
		{
			try
			{
				...
				{
					Console.Write($"TURA {game.HowManyAttemps()} | Podaj liczbę z przedziału [0 - {range}]: ");
					...
					{
						case 0:
							Console.WriteLine($"Brawo, wylosowana liczba to {number}! Wygrałeś w {game.HowManyAttemps()} turach.");
							break;
						case 1:
